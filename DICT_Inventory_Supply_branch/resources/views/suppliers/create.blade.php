    ...
    <div class="container-fluid supplier-section">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <br>
                <div>
                    <a class="btn btn-primary" href="{{ route('suppliers.index') }}" style="margin-left:96%"> Back</a>
                </div>
                <div class="pull-left">
                    <h2 style="font-family: Poppins, sans-serif; text-align: left;"> <i class="bi bi-people" style=""></i> Create a New Supplier</h2>
                </div>
                <div class="pull-right">
                    <br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('adminHome') }}" style="color:black">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:black"><a href="{{ route('suppliers.index') }}" style="color:black">Supplier Management</a></li>
